        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
            <div className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p className="text-xs text-gray-500">{points} Karma Points</p>
                </div>
            ...
            <div className="space-y-4">
                <div>
                    <div className="flex items-center justify-between text-xs mb-1">
                        ...
                        <span className="font-medium text-gray-900">{dailyProgress}/{dailyGoal}</span>
                    </div>
                ...
                <div className="flex items-center gap-2 bg-orange-50 p-2 rounded-lg border border-orange-100">
                    ...
                    <div>
                        <div className="text-xs font-bold text-orange-700">{currentStreak} Day Streak</div>
